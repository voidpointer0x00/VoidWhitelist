...
public final class OrmliteDatabase {
    ...
    @Getter private Dao<TimesAutoWhitelistedModel, UUID> autoWhitelistDao;
    ...
    private void createDataAccessObjects0() throws SQLException {
        ...
        TableUtils.createTableIfNotExists(connectionSource, TimesAutoWhitelistedModel.class);
        ...
        autoWhitelistDao = createDao(connectionSource, TimesAutoWhitelistedModel.class);
